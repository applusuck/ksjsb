...
代理环境");
  ...
  "llsid": 0,
  "data": {
    "md5": "4ca3e62531c825b0b047ea26093d1bcc",
    "templates": [
      {
        "templateId": "adtk-card-external-coupon",
        "templateUrl": "https://p1.adkwai.com/kos/nlav11461/r_adtk-card-external-coupon.105.js",
        "templateVersion": "1.0.5",
        "templateVersionCode": 105,
        "templateMd5": "7643709ea3524e1bf7fa4a3b96828023",
        "greyType": 2,
        "productType": 1,
        "matrixStyleTemplateRule": {
          "platforms": "[]",
          "appVersions": "{\"startVer\":\"10.3.10\",\"endVer\":null}",
          "env": "ALL"
        }
      },
      {
        "templateId": "adtk-neo-play-end-shop-v1",
        "templateUrl": "https://js.a.kspkg.com/kos/nlav10814/r_adtk-neo-play-end-shop-v1.101.js",
  ...
  async ["ksNeoAdReward"](T, c, p) {
    ...
    if (B["result"] == 1) {
      ...
      if (B["data"]["neoToH5Data"]) {
        try {
          let U = JSON["parse"](_0x331719["decode"](B["data"]["neoToH5Data"])["replace"](//g, ''));
...
"));
    ...
    [p["bdYaD"]](S, a) {
      ...
      Y ? this["log"]('', p["wQqon"]('??', this[p["Gfcja"]]) + ", 错误!", S["stack"]) : this["log"]('', p["gqCJK"]('??' + this[p["Gfcja"]], ", 错误!"), S);
    }
...
"));
    ...
    [p["UpyIA"]](S, a) {
      if (p["NjfUP"] === p["NjfUP"]) {
        ...
        Y ? this[p["zptFf"]]('', '??' + this[p["hxvZu"]] + p["PLJvd"], S[p["yObaT"]]) : this['log']('', p["fkDrB"](p["CjPRq"]('??', this[p["hxvZu"]]), p['PLJvd']), S);
      } else {
        return p - C;
      }
    }
